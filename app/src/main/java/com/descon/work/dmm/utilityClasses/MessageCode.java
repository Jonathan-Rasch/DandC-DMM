...
public abstract class MessageCode {
    ...
    public static final String SIGGEN_ACK = "SIGGEN_ACK";//sent periodically from DMM to app to confirm correct siggen settings
    ...
    public static final String PARSED_AC_VOLTAGE = "PARSED_AC_VOLTAGE";
    ...
    /*codes for extra data in diode mode change request*/
    public static final String DIODE_TYPE = "DIODE_TYPE";
    public static final String DIODE_TYPE_DIODE = "DIODE";
    public static final String DIODE_TYPE_ZENER = "ZENER";
